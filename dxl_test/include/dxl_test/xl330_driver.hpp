...
#define RAD_TO_DXL_POSITION 651.088636364 // 1 / 0.0174533 / 0.088  (1 rad ~ 651 tick, motor resolution 0.088)
#define RAD_S_TO_RPM 9.549 // 60 / (2*PI)     convert rad -> RPM
#define RPM_TO_DXL_VELOCITY 4.366812227 // 1 / 0.229 Convert RPM -> Velocity register
...
class XL330Driver {
    public:
        XL330Driver(std::string device_name){
            ...
            // packetHandler_  -> Quan ly viec dong goi/gui/nhan goi tin theo giao thuc Dynamixel 2.0
        ...
        {
            // Nhận góc mong muốn (rad) → chuyển sang đơn vị tick.
            // +2048 vì XL330 có giá trị 0 rad ở giữa (2048 tick).
        ...
        {
            // Đọc vị trí hiện tại (tick).
            // Chuyển đổi sang rad, đồng thời dịch gốc 2048 → 0 rad.
        ...
        {
            // đọc tốc độ hiện tại. Đổi sang rad/s.
...
/*
sơ đồ dòng dữ liệu (PC → USB2Dynamixel → PortHandler → PacketHandler
*/