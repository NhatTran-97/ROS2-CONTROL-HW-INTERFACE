...
class MPU6050_Driver(Node):
    def __init__():
        ...
        self.imu_msg_ = Imu()
        self.imu_msg_.header.frame_id = "base_link"
    ...
    def timerCallback(self):
        try:
            ...
            self.imu_msg_.angular_velocity.x = gyro_x / 17509.55
            self.imu_msg_.angular_velocity.y = gyro_y / 17509.55
            self.imu_msg_.angular_velocity.z = gyro_z / 17509.55
    ...
    def init_i2c(self):
        try:
            ...
            self.bus_.write_byte_data(DEVICE_ADDRESS, PWR_MGMT_1, 7)
